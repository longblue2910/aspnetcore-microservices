...
try
{
    ...
    //    async (Customer.API.Entities.Customer customer, ICustomerRepository repository) =>
    //    {
    ...
    //   async (int id, ICustomerRepository repository) => 
    //   {
    //       var customer = await repository
    //        .FindByCondition(x => x.Id.Equals(id))
    //        .SingleOrDefaultAsync();

    //       if (customer == null) Results.NotFound();
